...
* @author akash
*/
public class ProjectManagementGUI extends javax.swing.JFrame {
   ...
   public ProjectManagementGUI() {
       initComponents();
       ProjectManagementController = new ProjectManagementController(this);
       addButtonJTable();
   }
   ...
   public static void main(String args[]) {
       ...
       try {
           ...
           java.util.logging.Logger.getLogger(ProjectManagementGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       java.awt.EventQueue.invokeLater(new Runnable() {
           public void run() {
               new ProjectManagementGUI().setVisible(true);
           }
       });
   }
