...
* @author akash
*/
public class AddUpdateProjectGUI extends javax.swing.JFrame {

   /**
    * Creates new form AddUpdateGUI
    */
   public AddUpdateProjectGUI() {
       initComponents();
   }
   ...
   public static void main(String args[]) {
       ...
       try {
           ...
           java.util.logging.Logger.getLogger(AddUpdateProjectGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       java.awt.EventQueue.invokeLater(new Runnable() {
           public void run() {
               new AddUpdateProjectGUI().setVisible(true);
           }
       });
   }
