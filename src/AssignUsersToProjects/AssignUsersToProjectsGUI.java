...
public class AssignUsersToProjectsGUI extends javax.swing.JFrame {
   ...
   /**
    * Creates new form AssignUsersToProjectsGUI
    */
   ...
   public static void main(String args[]) {
       ...
       try {
           ...
           java.util.logging.Logger.getLogger(AssignUsersToProjectsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       java.awt.EventQueue.invokeLater(new Runnable() {
           public void run() {
               new AssignUsersToProjectsGUI().setVisible(true);
           }
       });
   }
